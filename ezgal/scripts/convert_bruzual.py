...
if sfh and met and imf:
	...
	if sfh == 'Burst': primary_hdu.header.update( 'length', tau, comment='meta data' )

# store the list of frequencies in a table
vs_hdu = pyfits.new_table(pyfits.ColDefs([pyfits.Column(name='vs', array=vs, format='D', unit='hertz')]))
