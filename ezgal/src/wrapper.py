...
class wrapper(object):
	...
	def get_kcorrects( self, zf, filters=None, zs=None ):
		...
		return self._get_data( zf, kind='kcorrects', filters=filters, zs=zs, normalize=False )
	...
	def get_ecorrects( self, zf, filters=None, zs=None ):
		...
		return self._get_data( zf, kind='ecorrects', filters=filters, zs=zs, normalize=False )
	...
	def get_ekcorrects( self, zf, filters=None, zs=None ):
		...
		return self._get_data( zf, kind='ekcorrects', filters=filters, zs=zs, normalize=False )
